    ...
    <Card className="quote-card-view">
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          Hello! My name is Akhil Bharambe. I am an independent developer & designer. I like many different directions related to the development of digital products.
            <br/>
            <br/>
